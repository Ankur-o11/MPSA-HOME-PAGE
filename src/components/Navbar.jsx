      ...
      <div className="header-top-bar">
        <div className="container top-bar-content">
          ...
          <div className="top-bar-social">
            <a href={contactSettings.facebookUrl || socialLinks?.facebook || SCHOOL_CONFIG.socialLinks.facebook} target="_blank" rel="noreferrer" title="Facebook">
            ...
            <a href={contactSettings.youtubeUrl || socialLinks?.youtube || SCHOOL_CONFIG.socialLinks.youtube} target="_blank" rel="noreferrer" title="YouTube">
