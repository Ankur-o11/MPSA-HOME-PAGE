      ...
      <div className="header-top-bar">
        <div className="container top-bar-content">
          <div className="top-bar-info">
            <a href={`tel:${SCHOOL_CONFIG.phonePrimary}`} className="top-bar-item">
              <Phone size={14} />
              <span>{SCHOOL_CONFIG.phonePrimary}</span>
            </a>
            <a href={`mailto:${SCHOOL_CONFIG.emailGeneral}`} className="top-bar-item">
              <Mail size={14} />
              <span>{SCHOOL_CONFIG.emailGeneral}</span>
            </a>
          </div>
          <div className="top-bar-social">
            <a href={SCHOOL_CONFIG.socialLinks.facebook} target="_blank" rel="noreferrer" title="Facebook">
            ...
            <a href={SCHOOL_CONFIG.socialLinks.instagram} target="_blank" rel="noreferrer" title="Instagram">
            ...
            <a href={SCHOOL_CONFIG.socialLinks.youtube} target="_blank" rel="noreferrer" title="YouTube">
