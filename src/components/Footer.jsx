        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-social-links">
              <a href={SCHOOL_CONFIG.socialLinks.facebook} target="_blank" rel="noreferrer" className="footer-social-btn" title="Facebook">
              ...
              <a href={SCHOOL_CONFIG.socialLinks.instagram} target="_blank" rel="noreferrer" className="footer-social-btn" title="Instagram">
              ...
              <a href={SCHOOL_CONFIG.socialLinks.youtube} target="_blank" rel="noreferrer" className="footer-social-btn" title="YouTube">
          ...
          <div className="footer-col">
            ...
            <div className="footer-contact-list">
              ...
              <div className="footer-contact-item">
                <Phone size={18} />
                <span>{SCHOOL_CONFIG.phonePrimary} / {SCHOOL_CONFIG.phoneSecondary}</span>
              </div>
              <div className="footer-contact-item">
                <Mail size={18} />
